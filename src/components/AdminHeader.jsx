...
export const AdminHeader = ({ scrolled = true }) => {
  ...
  const adminNavItems = [
    ...
    { label: 'Movies', onClick: () => navigate('/admin/movies') },
    { label: 'Genres', onClick: () => navigate('/admin/genres') },
    { label: 'Users', onClick: () => navigate('/admin/users') },
    { label: 'Actors', onClick: () => navigate('/admin/actors') }
  ];
